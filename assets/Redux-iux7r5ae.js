...
// => { type: "counter/incrementedByAmount", payload: 5 }`})]})}function M(){let e=u(e=>e.counter.value),t=d();return(0,h.jsxs)(`div`,{className:`bg-surface-alt border border-line rounded p-6`,children:[(0,h.jsxs)(`p`,{className:`text-muted mb-4`,children:[`Every button below dispatches a plain action object to the same store.`,` `,(0,h.jsx)(`code`,{children:`state.counter.value`}),` is currently `,(0,h.jsx)(`strong`,{children:e}),`.`]}),(0,h.jsxs)(`div`,{className:`flex flex-wrap gap-3 mb-4`,children:[(0,h.jsx)(`button`,{onClick:()=>t(c()),className:`bg-surface border border-line text-heading px-4 py-2 rounded hover:border-accent transition-colors`,children:`−1`}),(0,h.jsx)(`button`,{onClick:()=>t(a()),className:`bg-accent text-white px-4 py-2 rounded hover:opacity-90 transition-opacity`,children:`+1`}),(0,h.jsx)(`button`,{onClick:()=>{e%2!=0&&t(a())},className:`bg-surface border border-line text-heading px-4 py-2 rounded hover:border-accent transition-colors`,children:`+1 if odd`}),(0,h.jsx)(`button`,{onClick:()=>{setTimeout(()=>t(a()),1e3)},className:`bg-surface border border-line text-heading px-4 py-2 rounded hover:border-accent transition-colors`,children:`+1 async`})]}),(0,h.jsx)(p,{children:`incrementButton.addEventListener('click', () => {
